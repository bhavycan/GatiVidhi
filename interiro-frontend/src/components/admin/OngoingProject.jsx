...
const OngoingProject = () => {
 ...
 <figure className='w-[25vw] h-[30vw] absolute bottom-[2%] left-[10%]'>
        ...
        <header>
            <div
             className="title w-full text-6xl font-semibold tracking-tight mt-[6%]  h-[20%] flex  ">
                <h1 className='h-full'>On</h1>
                <h1 className='h-full text-white'>Going</h1>
            </div>
            <div className="subtitle w-[100%] pb-[6%] font-semibold text-md opacity-70 leading-5  pl-[2%] border-b-2 border-white">
                <h4 className='w-[65%]'>Projects currently under work</h4>
            </div>
        </header>
        ...
        <section ref={parent} className='w-full max-h-[80%] flex  flex-col gap-[%] items-center overflow-y-auto mt-[5%]'>
            ...
            {Array.from({length: 6}).map((item,index)=>{
                return(  <div className='card h-[70%] w-full flex-shrink-0 rounded-2xl shadow-2xl   backdrop-blur-lg mb-[10%]  shadow-[#883bbc]  px-[5%] py-[4%]'>

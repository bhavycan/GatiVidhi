          ...
          <header className='mb-8'>
            ...
            <div className='flex items-center gap-4'>
              <div className='w-16 h-16 rounded-full bg-[#f3a9de] border-2 border-[#883bbc] flex items-center justify-center shrink-0'>
                <i className='ri-shield-user-line text-3xl text-[#883bbc]'></i>
              </div>
              <div>
                <h1 className='text-3xl font-bold'>{admin.name || '—'}</h1>
                <p className='text-sm text-white opacity-70 font-medium'>{admin.email}</p>
                <span className='text-xs bg-[#883bbc] text-white px-2 py-0.5 rounded-full font-semibold mt-1 inline-block'>Admin</span>
              </div>
            </div>
          </header>
